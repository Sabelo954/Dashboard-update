...
export let counties_disabl_pov = `
  <div id="disabl_pov" style="display: none">
    ...
    <div class="Table">
      ...
      <div class="Footer">
        <div class="FootLeft">
          <p id="disabl_pov_chart_footer">Source: American Community Survey <span id='acsyearagg'>5</span>-Year Estimates (Date Last Accessed: April 19, 2021)</p>
        </div>
      </div>
    </div>
  </div>
...
export let counties_tanf = `
  <div id="tanf" style="display: none">
    ...
    <div class="Table">
      ...
      <div class="Footer">
        <div class="FootLeft">
          <p id="tanf_chart_footer">Source: Administrative Data from Temporary Assistance to Needy Families (TANF) and MD Wage Records (Date Last Accessed: April 19, 2021) <br><br> "--" means data is not available. </p>
        </div>
      </div>
    </div>
  </div>
